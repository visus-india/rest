...
<html>
	<head>
		<title>Healthcare Jobs - Login</title>
						...
						<form method="POST" action ="<?php echo $_SERVER['PHP_SELF'];?>">
							...
							<div class="textbox-wrap">
								...
								<div class="input-group col-md-10">
									...
									OBvalidateEmailId('lusername','lnerror');OBenableLoginButton();" 
									id="lusername" name="lusername" class="form-control" placeholder=" Enter Username (email) eg. abc@xyz.com">
							...
							<div class="textbox-wrap">
								<div class="input-group col-md-10 ">
									...
									id="lpassword"  name="lpassword" class="form-control " placeholder="Enter Password"> 
							...
							<div class="">								
								<input type="submit" id="submitbutton" style="margin-bottom:20px;" class="btn btn-primary col-md-10" value="Log in"  disabled />
